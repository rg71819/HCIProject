...
$new_password = $confirm_password =  $new_SecurityQuestion1 = $new_SecurityQuestion2 = $new_SecurityQuestion3 = $new_SecurityQuestionAnswer1 = $new_SecurityQuestionAnswer2 = $new_SecurityQuestionAnswer3 = $new_thirdPassword = "";
$new_password_err = $confirm_password_err = $new_SecurityQuestion1_err =  $new_SecurityQuestion2_err =  $new_SecurityQuestion3_err = $new_SecurityQuestionAnswer1_err = $new_SecurityQuestionAnswer2_err = $new_SecurityQuestionAnswer3_err = $new_thirdPassword_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($new_password_err) && empty($confirm_password_err) && empty($confirm_SecurityQuestion1_err) && empty($confirm_SecurityQuestion2_err) && empty($confirm_SecurityQuestion3_err) && empty($confirm_SecurityQuestionAnswer2_err) && empty($confirm_SecurityQuestionAnswer2_err) && empty($confirm_SecurityQuestionAnswer3_err) && empty($confirm_thirdPassword_err)){
        // Prepare an update statement
        $sql = "UPDATE userdetails SET firstPassword = ? , SecondPasswordfirstQuestion = ? , SecondPasswordFirstAnswer = ? , SecondPasswordsecondQuestion = ? , SecondPasswordSecondAnswer = ? , SecondPasswordthirdQuestion = ? , SecondPasswordThirdAnswer = ? , thirdPassword = ?  WHERE id = ?";
        $id=$_SESSION['id'];
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssssssssi", $param_password, $param_SecondPasswordfirstQuestion, $param_SecurityQuestionAnswer1, $param_SecondPasswordsecondQuestion, $param_SecurityQuestionAnswer2, $param_SecondPasswordthirdQuestion, $param_SecurityQuestionAnswer3, $param_thirdPassword, $param_id);
